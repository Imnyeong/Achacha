...
public class RegisterSajang extends AppCompatActivity {
    EditText ed_id, ed_pw, ed_pw2, ed_mail, ed_age, ed_strnum, ed_strname, ed_tel;
    String sid, spw, spw2, smail, ssex = "", sstrname, sage, sstrnum, stel;
    Integer iage, istrnum, itel;
    public String rslt;
    RadioGroup rdio;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_register_sajang);
        ...
        ed_strnum = (EditText) findViewById(R.id.storenumreg);
        ed_strname = (EditText) findViewById(R.id.storenamereg);
        ...
        regbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                sstrnum = ed_strnum.getText().toString();
                sstrname = ed_strname.getText().toString();
                stel = ed_tel.getText().toString();


                if(sid.matches("") || spw.matches("") || spw2.matches("") || smail.matches("") || sage.matches("") ||
                sstrnum.matches("") || sstrname.matches("") || stel.matches("") || rdio.getCheckedRadioButtonId() == -1)
                {
                ...
                } else if(stel.getBytes().length < 10 ) {
                    Toast.makeText(getApplicationContext(), "전화번호를 확인해주세요.", Toast.LENGTH_LONG).show();
                } else{
                    iage = Integer.parseInt(ed_age.getText().toString());
                    istrnum = Integer.parseInt(ed_strnum.getText().toString());
                    itel = Integer.parseInt(ed_tel.getText().toString());
    ...
    public class Regist extends AsyncTask<Void, Integer, Void> {
        ...
        protected Void doInBackground(Void... unused) {
            ...
            try {
                ...
                buffer.append("store_Num").append("=").append(sstrnum).append("&");
                buffer.append("store_Name").append("=").append(sstrname).append("&");
                buffer.append("tel").append("=").append(stel).append("&");
                buffer.append("store_Check").append("=").append(1);
